...
# Controller for testing ActionDSL with mock service
# Uses mock data instead of database for unit testing DSL behavior
class ActionDslProductsController < ActionController::Base
